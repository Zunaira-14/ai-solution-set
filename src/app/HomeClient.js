        ...
        <section className="mt-16">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg sm:text-xl font-semibold text-white">
              Try the AI Tools Dashboard
            </h2>
            <Link
              href="/dashboard"
              className="inline-flex items-center gap-1 text-xs sm:text-sm text-indigo-300 hover:text-white"
            >
              Open dashboard
          ...
          <p className="text-[11px] sm:text-xs text-gray-400 max-w-md">
            Explore AI Code Fixer, Summarizer, JSON Formatter, Image Optimizer,
            and API Tester inside a single, focused workspace.
          </p>
        </section>

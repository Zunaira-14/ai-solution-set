...
//                 <div
//                   key={index}
//                   className="group flex items-center gap-4 p-4 bg-white/30 border border-white/40 rounded-2xl hover:bg-white/50 hover:scale-[1.02] transition-all duration-300 shadow-sm"
//                 >

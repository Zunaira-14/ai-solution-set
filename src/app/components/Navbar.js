      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <Link href="/" className="flex items-center space-x-3">
          ...
          <span className="text-2xl font-bold text-white tracking-tight">
            DevPulse<span className="text-indigo-500">.ai</span>
          </span>
        </Link>
        ...
        <div className={`${isOpen ? "block" : "hidden"} w-full md:block md:w-auto`}>
          <ul className="flex flex-col md:flex-row md:space-x-8 items-center p-4 md:p-0 mt-4 md:mt-0 border border-gray-800 md:border-0 rounded-lg">
            ...
            <li className="relative group md:block hidden">
              ...
              {/* Tools Dropdown */}
              <div className="absolute top-full left-0 mt-2 w-40 bg-black/90 backdrop-blur-md border border-gray-800 rounded-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
          ...
          <div className={`${isOpen ? "block mt-4" : "hidden"} md:hidden border-t border-gray-800 pt-4`}>
            ...
            <h3 className="text-white font-semibold mb-4 px-2">Quick Tools</h3>
